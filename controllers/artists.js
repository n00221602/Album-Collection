...
artistRouter.get("/:id", validate(artistIdSchema), async (req, res) => {
...
// Create new artist
artistRouter.post("/", requireAdmin, validate(artistSchema), async (req, res) => {
...
// Update artist
artistRouter.put("/:id", requireAdmin, validate(artistIdSchema), validate(artistSchema), async (req, res) => {
    const { name, releases, bio } = req.body;
...
// Delete artist
artistRouter.delete("/:id", requireAdmin, validate(artistIdSchema), async (req, res) => {
